 ...
 */
function spot_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['spot_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('spot sample setting'),
  '#default_value' => theme_get_setting('spot_example'),
